...
public class Formulario extends JFrame implements ActionListener {
	...
	public Formulario() {
		...
		pTabla.setBorder(BorderFactory.createTitledBorder(BorderFactory.createBevelBorder(NORMAL), "Listado de Naves", JLabel.CENTER,
				JLabel.CENTER, fLabel, Color.GRAY));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(bt==bCrear) {
			nave= new Nave(tCodigo.getText(), tModelo.getText(), cPlaneta.getSelectedItem().toString(), this.getVelocidad());
